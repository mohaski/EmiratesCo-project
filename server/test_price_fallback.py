...
def test():
    ...
    v = MockVariant(price=0)
    line = {"type": "profile-full", "qty": 3, "rate": 2000}

    total = calculate_logic(v, line)
    ...
    v2 = MockVariant(price=1500)
    line2 = {"type": "profile-full", "qty": 3, "rate": 2000}

    total2 = calculate_logic(v2, line2)
