    ...
    return (
        <div style={{ minHeight: '100%', background: 'var(--color-bg)', display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{
                ...
                <div>
                    <h1 style={{ fontSize: '1.375rem', fontWeight: 800, color: '#f1f5f9', margin: 0, letterSpacing: '-0.025em' }}>Cutting Queue</h1>
            ...
            {/* Body */}
            <div style={{ flex: 1, padding: '1.5rem 2rem', display: 'flex', flexDirection: 'column', gap: '0.75rem', paddingBottom: selected.size > 0 ? '5.5rem' : '1.5rem' }}>
                {error && (
                ...
                {loading ? (
                    ...
                    <p style={{ color: '#334155', fontSize: '0.85rem', fontStyle: 'italic' }}>Nothing waiting on a cutting report.</p>
                ) : (
                    items.map(item => {
            ...
            {selected.size > 0 && (
                <div style={{
                    position: 'sticky', bottom: 0, padding: '1rem 2rem', borderTop: '1px solid rgba(255,255,255,0.07)',
