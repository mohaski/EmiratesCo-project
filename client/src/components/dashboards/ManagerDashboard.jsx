...
const ManagerDashboard = () => {
    ...
    const quickActions = [
        ...
        { label: 'Debt Management', sub: 'Collect payments & follow up balances', icon: '💼', path: '/debt-management', color: '#f59e0b' },
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }} className="animate-fade-in-up">
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '1rem' }}>
                ...
                <div style={{
                    ...
                    <div style={{ fontSize: '1rem', fontWeight: 700, color: '#f1f5f9', marginBottom: '1.25rem' }}>Store Overview</div>
